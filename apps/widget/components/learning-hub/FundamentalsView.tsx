...
export default function FundamentalsView({
  ...
  if (!hasContent) {
    return (
      <>
        ...
        <NoDataState
          icon="📚"
          title="No fundamentals content yet"
          description="We're working on curating foundational content for you. Check back soon!"
          actionText="Check Market Updates"
        />
      </>
    );
  }
  ...
  return (
    <motion.div key="fundamentals-view" initial="hidden" animate="visible" exit="hidden" variants={containerVariants}>
      {/* Progress Wheels Section */}
      <ProgressWheels />
      ...
      {recommendedVideos.length > 0 && (
        <motion.section className="explore-videos-section" variants={sectionVariants}>
          <div className="section-header">
            ...
            <p className="section-subtitle">Start building your foundation</p>
          </div>
      ...
      {podcasts.length > 0 && (
        <motion.section className="listen-learn-section" variants={sectionVariants}>
          <div className="section-header">
            ...
            <p className="section-subtitle">Learn on the go</p>
          </div>
      ...
      {articles.length > 0 && (
        <motion.section className="listen-learn-section" variants={sectionVariants}>
          <div className="section-header">
            ...
            <p className="section-subtitle">Deep dives into the fundamentals</p>
          </div>
