...
/**
 * POST /api/org/[orgSlug]/submissions/[submissionId]/podcast/[podcastId]/upload-thumbnail
 * Upload a custom thumbnail for a podcast output
 */
export async function POST(
  ...
  try {
    ...
    const result = await SubmissionsController.uploadPodcastThumbnail(
      params.podcastId,
      buffer,
    ...
    console.error('Upload Podcast Thumbnail Error:', error);
    return NextResponse.json(
      {
        success: false,
