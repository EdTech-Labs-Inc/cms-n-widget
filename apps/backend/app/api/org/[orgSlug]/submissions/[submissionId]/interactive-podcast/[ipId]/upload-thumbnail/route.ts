...
/**
 * POST /api/org/[orgSlug]/submissions/[submissionId]/interactive-podcast/[ipId]/upload-thumbnail
 * Upload a custom thumbnail for an interactive podcast output
 */
export async function POST(
  ...
  try {
    ...
    const result = await SubmissionsController.uploadInteractivePodcastThumbnail(
      params.ipId,
      buffer,
    ...
    console.error('Upload Interactive Podcast Thumbnail Error:', error);
    return NextResponse.json(
      {
        success: false,
